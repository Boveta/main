                ...
                <form id="ValuatorForm" runat="server">
                    <table class="center">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TBAddress" runat="server" Width="200px" autocomplete="off"  placeholder="Enter address"></asp:TextBox></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="DDLCountry" runat="server" Width="200px" CssClass="ddl" OnSelectedIndexChanged="DDLCountry_SelectedIndexChanged">
                                    <asp:ListItem Selected="True">Netherlands</asp:ListItem>
